...
namespace Engine {
	const std::string Resources::bitmapPathPrefix = "desktop/Tower/resources/images/";
	const std::string Resources::fontPathPrefix = "desktop/Tower/resources/fonts/";
	const std::string Resources::samplePathPrefix = "desktop/Tower/resources/audios/";
