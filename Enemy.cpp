...
//		if (money == 50) {
//            //getPlayScene()->EnemyGroup->RemoveObject(objectIterator);
//            //getPlayScene()->EnemyGroup->AddNewObject(new DiceNormalEnemy2(Position.x+100,Position.y));
...
void Enemy::Update(float deltaTime) {
	if (money == 200) {
        ...
        if(gentime >= 10){
            ...
            gentime = 0;
            Enemy* enemy;
            getPlayScene()->EnemyGroup->AddNewObject(enemy = new Little(Position.x, Position.y));
